                ...
                <div class="span9">
                        <form class="form-horizontal row-fluid" action="book.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from buku where Id_buku='$s' or Title like '%$s%'";
                                        }
                                    else
                                        $sql="select * from buku order by Jml_tersedia DESC";
                            ...
                            ?>
                                    <tr style="text-align: center;">
                                      ...
                                      <td><center><a href="bookdetails.php?id=<?php echo $bookid; ?>" class="btn btn-primary">Details</a>
                                      	<?php
                                      	if($avail > 0)
                                      		echo "<a href=\"issue_request.php?id=".$bookid."\" class=\"btn btn-success\">Pinjam</a>";
                                        ?>
                                        </center></td>
                                    </tr>
                               <?php }} ?>
